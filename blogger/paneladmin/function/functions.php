...
// koneksi ke database
$conn = pg_connect("host=localhost dbname=webgis user=postgres password=admin");
...
function hapus($ID){
	global $dbconn;
	$query = pg_query($dbconn, "DELETE FROM  hotel22 WHERE gid = '$ID'");
...
function tambah($data){
	...
	$query = pg_query ("INSERT INTO hotel22 (id,nama,lat,lng,kategori,alamat) VALUES ('$ID','$nama','$lat','$lng','$kategori','$alamat')");
