    ...
    if(isset($_POST["login"]))
{
        ...
        $password = $_POST['password'];
            ...
            $sql = pg_query($dbconn,"SELECT username, password FROM users where username = '$user' AND password = '$password'") or die(pg_error());
    ...
    <div class="container">
        <br><br><br><br>
            <div class="col-md-4 col-md-offset-4">
             ...
             <input class="form-control" placeholder="username"  id="user" name="user" type="text" autofocus autocomplete="off">
                                </div>
                                <div class="form-group">
